...
create_clock -name {CLK2} -period 38.462 -waveform { 0.000 19.231 } [get_ports {CLK2}]
...
set_clock_groups -exclusive -group [get_clocks {clk_gen:main_clk_gen|altpll:altpll_component|clk_gen_altpll:auto_generated|wire_pll1_clk[0]}] -group [get_clocks {mipi_clkpll_v2:mipi_clk_gen|altpll:altpll_component|mipi_clkpll_altpll:auto_generated|wire_pll1_clk[0]}]
